...
class User(AbstractUser):
    ...
    matric_number = models.CharField(max_length=15, unique=True,blank = True,null = True)
    examiner_id = models.CharField(max_length=15, unique=True, blank = True,null = True)
