...
urlpatterns = [
    ...
    path('upload/students/', BulkStudentUploadAPIView.as_view(), name='bulk-student-registration'),
    ...
    path('delete-student/<int:pk>/', StudentDetailView.as_view(), name = 'delete-student'),
